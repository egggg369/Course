...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor colorWithRed:229/255.0 green:229/255.0 blue:229/255.0 alpha:1];
        ...
        _scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height - 170)];
        ...
        _tableView1 = [[UITableView alloc] initWithFrame:CGRectMake(20, 60, self.view.frame.size.width - 40, self.view.frame.size.height - 240) style:UITableViewStyleGrouped];
...
//        return cell;
        ...
        holdbtn.layer.masksToBounds = YES;
