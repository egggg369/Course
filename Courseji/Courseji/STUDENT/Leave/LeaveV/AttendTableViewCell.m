...
@implementation AttendTableViewCell
...
- (void)layoutSubviews {
    ...
    self.signLabel.backgroundColor = [UIColor colorWithRed:49/255.0 green:182/255.0 blue:105/255.0 alpha:1];
