...
- (void)viewDidLoad {
    ...
    _leaveView = [[LeaveView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height)];
    [_leaveView viewInit];
    [self.view addSubview:_leaveView];
    _leaveView.tableView.delegate = self;
    _leaveView.tableView.dataSource = self;
...
{
    LeaveTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
